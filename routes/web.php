...
Route::get('/keep/trash/{nota}/delete', [KeepController::class, 'deleteDefinitivo']) -> withTrashed() -> name('keep.trash.delete');
Route::delete('/keep/trash/{nota}/delete', [KeepController::class, 'deleteDefinitivo']) -> withTrashed();
